...
/**The **ReactNativeLogo** component renders an icon with the shape of the React Native logo. */
export default {
  title: 'Atoms/Logos/ReactNativeLogo',
...
/** This is the default version of the **ReactNativeLogo** component:*/
